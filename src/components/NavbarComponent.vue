...
<template>
	<nav class="navbar navbar-expand-lg sticky-top bg-light shadow-sm">
	  <div class="container">
	    <router-link :to="{name: 'Home'}" class="navbar-brand text-dark fw-bold">MTE</router-link>
	    ...
	    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	      <div class="navbar-nav ms-auto">
	        ...
	        <router-link :to="{ name: 'AddPost' }" class="nav-link" v-if="user.email">Add Post</router-link>
